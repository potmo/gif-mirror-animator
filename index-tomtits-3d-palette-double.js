...
async function run() {
  ...
  settings.three_dee.mirror_board_width = settings.input.mirrors.width * (settings.three_dee.mirror_diameter + settings.three_dee.mirror_padding);
  settings.three_dee.mirror_board_height = settings.input.mirrors.height * (settings.three_dee.mirror_diameter + settings.three_dee.mirror_padding);
...
function getSettings() {
  let settings =  {
    ...
    three_dee: { // units in meters
      ...
      mirror_diameter: 0.026, // this is the diameter of the mirror
      mirror_padding: 0.000, // the padding between mirrors
      mirror_board_diameter: undefined, // declared later programmatically
      mirror_board_width: undefined, // declared later programmatically
      mirror_board_height: undefined, // declared later programmatically
